...
const log = m => console.log('[sahara] ' + m);
...
const SECURITY = {
  storage:  'Your answers are held in one database that only this application can reach. Nothing is sent to any third party, and there is no analytics or advertising code anywhere in Sahara.',
  passwords:'Your password is never stored. It is salted and stretched with PBKDF2-SHA512 over 120,000 rounds, and only the result is saved — nobody, including the people running Sahara, can read it back.',
